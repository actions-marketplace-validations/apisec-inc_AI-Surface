...
def detect_model_from_config(
    env_vars: dict, apis: Optional[list] = None, mcp_name: str = ""
    ...
    for env_key, env_value in env_vars.items():
        ...
        for pattern in MODEL_ENV_PATTERNS:
            if (pattern in env_key_upper or env_key_upper.endswith("_MODEL")
                    or env_key_upper.endswith("_MODEL_ID")):
